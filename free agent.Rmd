...
avg_clusters = hitting_free_agents_stats %>% plot_ly(type = 'scatter', x= ~as.numeric(avg), y= ~est_ba, marker = list(size = ~plate_appearances, sizeref = 5, sizemode = 'area'), fillcolor = ~as.factor(xba_cluster), text = ~player_full_name, hovertemplate = paste('<b>%{text}</b>
      %{yaxis.title.text}: %{y},
      %{xaxis.title.text}: %{x}'))
avg_clusters
```
...
slg_clusters = hitting_free_agents_stats %>% plot_ly(type = 'scatter', x= ~slg.y, y= ~est_slg, marker = list(size = ~plate_appearances, sizeref = 5, sizemode = 'area'), fillcolor = ~as.factor(xslg_cluster), text = ~player_full_name, hovertemplate = paste('<b>%{text}</b>
      %{yaxis.title.text}: %{y},
      %{xaxis.title.text}: %{x}'))
slg_clusters
```
...
diff_clusters = hitting_free_agents_stats %>% plot_ly(type = 'scatter', x= ~est_ba_minus_ba_diff, y= ~est_slg_minus_slg_diff, marker = list(size = ~plate_appearances, sizeref = 5, sizemode = 'area'), fillcolor = ~as.factor(diff_cluster), text = ~player_full_name, hovertemplate = paste('<b>%{text}</b>
      %{yaxis.title.text}: %{y},
      %{xaxis.title.text}: %{x}')) %>% layout(yaxis = list(autorange = "reversed"))%>% layout(xaxis = list(autorange = "reversed"))
diff_clusters
```
...
era_clusters = pitching_free_agents_stats %>% plot_ly(type = 'scatter', x= ~era.y, y= ~xera, marker = list(size = ~innings_pitched, sizeref = 2, sizemode = 'area'), fillcolor = ~as.factor(era_cluster), text = ~player_full_name, hovertemplate = paste('<b>%{text}</b>
      %{yaxis.title.text}: %{y},
      %{xaxis.title.text}: %{x}')) %>% layout(yaxis = list(autorange = "reversed"))%>% layout(xaxis = list(autorange = "reversed"))
era_clusters
```
...
pba_clusters = pitching_free_agents_stats %>% plot_ly(type = 'scatter', x= ~avg, y= ~est_ba, marker = list(size = ~innings_pitched, sizeref = 2, sizemode = 'area'), fillcolor = ~as.factor(xba_cluster), text = ~player_full_name, hovertemplate = paste('<b>%{text}</b>
      %{yaxis.title.text}: %{y},
      %{xaxis.title.text}: %{x}')) %>% layout(yaxis = list(autorange = "reversed"))%>% layout(xaxis = list(autorange = "reversed"))
pba_clusters
```
...
pslg_clusters = pitching_free_agents_stats %>% plot_ly(type = 'scatter', x= ~slg.y, y= ~est_slg, marker = list(size = ~innings_pitched, sizeref = 2, sizemode = 'area'), fillcolor = ~as.factor(xslg_cluster), text = ~player_full_name, hovertemplate = paste('<b>%{text}</b>
      %{yaxis.title.text}: %{y},
      %{xaxis.title.text}: %{x}')) %>% layout(yaxis = list(autorange = "reversed"))%>% layout(xaxis = list(autorange = "reversed"))
pslg_clusters
```